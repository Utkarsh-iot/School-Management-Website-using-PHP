		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">School<span>Management</span><p class="logo_w3l_agile_caption"></p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#team" class="menu__link scroll">Faculties</a></li>
							<li class="menu__item"><a href="#gallery" class="menu__link scroll">Glimpses</a></li>
							<li class="menu__item"><a href="home.php" > Logins </a></li>
				...
				<ul class="cbp-ig-grid">
					...
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">LARGE CANTEEN</h4>
							<span class="cbp-ig-category">SCHOOL</span>
						</div>
					</li>
					<li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our SCHOOL</h3> 
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Mitesh Pradhan</h4>
							<span>Math's Tutor</span>
							<p>Go down deep enough into anything and you will find mathematics.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="https://www.facebook.com/profile.php?id=100005124432628" class="fa fa-facebook icon-border facebook"> </a></li>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="https://www.facebook.com/profile.php?id=100010381602639" class="fa fa-facebook icon-border facebook"> </a></li>
					...
					<div class="tab3">
						...
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="https://www.facebook.com/profile.php?id=100006542988145" class="fa fa-facebook icon-border facebook"> </a></li>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Shivangi Sharma</h4>
							<span>Librarian</span>
							<p>Nothing is pleasanter than exploring a <strong>Library</strong>.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="https://www.facebook.com/millys.sharma" class="fa fa-facebook icon-border facebook"> </a></li>
...
<section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">Some Glimpses of our school</h3>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="img/g7.jpg" class="swipebox"><img src="img/g7.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>CLASSROOM</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 6206644049 | +91 8709069231</p>
			<p class="contact-agile1"><strong>Email :</strong>utkarshg048@gmail.com | shivangisharmamilly@gmail.com <a href="mailto:utkarshg048@gmail.com"></a></p>
			<p class="contact-agile1"><strong>Address :</strong> Adityapur, Jamshedpur, Jharkhand</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 SCHOOL . All Rights Reserved | Design by <a href="home.php">Utkarsh and Shivangi Sharma</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
